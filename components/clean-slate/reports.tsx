...
const auditLog: AuditEntry[] = [
  ...
  },
  {
    id: "AUD-002",
    date: "Jan 15, 2026",
    reason: "Credit Limit Increase Request",
    employeeId: "TD-32156",
    type: "limit",
  },
  {
  ...
  },
  {
    id: "AUD-004",
    date: "Nov 15, 2025",
    reason: "New Product Application",
    employeeId: "TD-78234",
    type: "application",
  },
];
    ...
    <div className="pb-12">
      ...
      <section className="px-8 pt-8 pb-10">
        ...
        <p className="text-sm text-white/40 leading-relaxed">
          Access your historical credit reports and see when TD accessed your
          information
        </p>
      </section>
            ...
            <div className="glass-card rounded-3xl p-7">
              ...
              <div className="flex gap-4">
                <Button
                  variant="outline"
                  size="lg"
                  className="flex-1 bg-transparent border-white/10 text-white hover:bg-white/5 rounded-xl h-14 font-semibold"
                >
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/40 mt-3 leading-relaxed">
                    This log shows every time TD accessed your credit
                    information and why. You can flag any suspicious access for
                    review.
                  </p>
                </div>
              </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="ghost"
            size="sm"
            className="h-12 w-12 p-0 text-white/30 hover:text-white hover:bg-white/5 rounded-xl"
          >
...
function AuditCard({ entry }: { entry: AuditEntry }) {
  const typeConfig = {
    review: {
      ...
      color: "bg-[#00D9A4]/15 text-[#00D9A4]",
    },
    limit: {
  ...
  return (
    <div className="glass-card rounded-2xl p-6">
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-5">
          <div
            className={`w-14 h-14 rounded-xl flex items-center justify-center ${config.color}`}
          >
            {config.icon}
          </div>
          <div>
