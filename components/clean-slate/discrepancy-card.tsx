    ...
    <div className={`glass-card rounded-2xl p-5 border-l-2 ${sev.borderColor}`}>
      <div className="flex items-start justify-between gap-4 mb-4">
        <div className="flex items-start gap-4">
          <div
            className={`w-12 h-12 rounded-xl ${sev.bg} ${sev.color} flex items-center justify-center flex-shrink-0`}
          >
            {sev.icon}
          </div>
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Badge
                className={`${stat.bg} ${stat.color} border-0 text-[10px] h-5 px-2.5 font-semibold`}
              >
                {stat.label}
              </Badge>
            </div>
