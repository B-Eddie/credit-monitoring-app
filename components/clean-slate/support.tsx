...
const articles = [
  ...
  {
    id: 2,
    title: "What Hurts Your Credit Most",
    category: "Education",
    readTime: "4 min",
  },
  {
    id: 3,
    title: "Understanding Hard vs Soft Inquiries",
    category: "Basics",
    readTime: "3 min",
  },
  {
    id: 4,
    title: "How to Dispute Errors Effectively",
    category: "Disputes",
    readTime: "6 min",
  },
  {
...
const glossary = [
  {
    ...
    definition: "The ratio of your credit card balances to your credit limits",
  },
  {
    term: "Hard Inquiry",
    definition: "A credit check that can temporarily lower your score",
  },
  {
    term: "Soft Inquiry",
    definition: "A credit check that doesn't affect your score",
  },
  {
    term: "Payment History",
    definition: "Record of on-time and late payments on your accounts",
  },
];
      ...
      <section className="px-8 pb-10">
        <div className="grid grid-cols-3 gap-5">
          ...
          <ContactCard
            ...
            label="Chat"
          />
          <ContactCard icon={<Phone className="w-6 h-6" />} label="Call" />
        </div>
      </section>
          ...
          <div className="glass-card rounded-3xl p-7 border border-[#00D9A4]/20">
            ...
            <div className="bg-white/5 rounded-2xl p-5 mb-5">
              <p className="text-sm text-white/70 leading-relaxed">
                Hi! I'm your Clean Slate AI assistant. I can help you understand
                your credit report, explain how disputes work, and answer
            ...
            <div className="flex gap-4">
              ...
              <Button
                size="icon"
                className="bg-gradient-to-r from-[#00D9A4] to-[#00B8A9] hover:opacity-90 text-[#0A0F14] rounded-xl h-14 w-14"
              >
      ...
      <section className="px-8 pb-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-10 text-sm text-[#00D9A4] hover:text-[#00FFB8] hover:bg-transparent font-semibold"
          >
            View All
          </Button>
        </div>
      ...
      <section className="px-8 pb-10">
        ...
        <div className="glass-card rounded-3xl p-7 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Badge className="bg-[#00D9A4]/15 text-[#00D9A4] border-0 text-xs px-4 py-1.5 font-semibold">
              24/7
            </Badge>
          </div>
...
function ArticleCard({
  ...
  article: { title: string; category: string; readTime: string };
}) {
  return (
...
function TopicBadge({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <Badge className="cursor-pointer bg-white/5 text-white/50 border-white/10 hover:bg-[#00D9A4]/15 hover:text-[#00D9A4] hover:border-[#00D9A4]/30 transition-all gap-2 px-5 py-2.5 text-sm font-medium">
      {icon}
      {label}
    </Badge>
  );
